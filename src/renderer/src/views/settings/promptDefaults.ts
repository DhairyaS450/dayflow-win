// Default prompt texts (verbatim from the porting spec §12). Shown as
// placeholders in the prompt-customization editors; the main process falls
// back to the same defaults when an override is absent.

export const GEMINI_TITLE_DEFAULT = `Titles
...
export const GEMINI_SUMMARY_DEFAULT = `## Summary
...
export const GEMINI_DETAILED_DEFAULT = `## Detailed Summary
...
export const OLLAMA_SUMMARY_DEFAULT = `SUMMARY GUIDELINES:
...
export const OLLAMA_TITLE_DEFAULT = `Write one activity title for a 15-minute window using ONLY the observations.
Rules:
